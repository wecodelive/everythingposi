...
export default function Accordion({
  ...
  return (
    <div className={`${className || "border-b-[0.5px] border-[#C9C9C9] py-3"}`}>
      <div
      ...
      >
        <div className="flex items-center">
          ...
          {titleIcon}
          <p
            className={`font-serif text-xl font-light tracking-widest text-black hover:text-neutral-600 transition text-left ${titleClassName}`}
          >
            {title}
          </p>
        </div>
