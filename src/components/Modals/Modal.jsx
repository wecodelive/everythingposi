        ...
        {closeModal && !authModal && (
          ...
          >
            <div
              ...
              className="
              bg-neutral_white w-8 h-8 flex items-center justify-center cursor-pointer hide_tap rounded-full"
            >
              <div className="bg-neutral_white w-8 h-8 flex items-center justify-center">
                {icon || (
                  <Close
        ...
        <AnimatePresence>
          {showChildren ? (
            <motion.div
              ...
              exit={animate()?.exit}
              className={`flex w-full ${isRightModal ? "relative pt-[30px]" : ""}`}
            >
              <div
