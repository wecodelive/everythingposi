  ...
  const metricsCards = useMemo(
    () => [
      ...
      },
      {
        ...
        value: formatCurrency(summary.totalRevenue, baseCurrency),
    ...
    [summary, baseCurrency, formatCurrency],
  );
        ...
        {adminSections.map((section) => {
          ...
          return (
            <div
              ...
              className="border border-[#DFDFDF] p-4 flex items-start justify-between hover:bg-gray-50 transition cursor-pointer"
            >
